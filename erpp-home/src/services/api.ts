...
export type DutyRosterStatus = 'Scheduled' | 'Completed' | 'Cancelled' | 'On Leave';
...
export const dutyRosterData: DutyRoster[] = [
  {
    id: 'DR001', empId: 'EMP001', empName: 'Ahmed Ali', department: 'Engineering', date: '2026-05-06',
    shift: 'Morning Shift', startTime: '09:00', endTime: '18:00', location: 'Head Office',
    status: 'Scheduled', assignedBy: 'HR Team', assignedAt: '2026-05-01T10:00:00Z',
  },
  {
    id: 'DR002', empId: 'EMP002', empName: 'Sara Khan', department: 'Marketing', date: '2026-05-06',
    shift: 'Morning Shift', startTime: '09:00', endTime: '18:00', location: 'Head Office',
    status: 'Scheduled', assignedBy: 'HR Team', assignedAt: '2026-05-01T10:05:00Z',
  },
  {
    id: 'DR003', empId: 'EMP004', empName: 'Fatima Raza', department: 'Sales', date: '2026-05-07',
    shift: 'Morning Shift', startTime: '09:00', endTime: '18:00', location: 'Branch B',
    status: 'On Leave', assignedBy: 'HR Team', assignedAt: '2026-05-02T09:20:00Z',
  },
];

export const dutyRosterTemplates: DutyRosterTemplate[] = [
  {
    id: 'T001', name: 'Office Morning', department: 'Engineering',
    shifts: [
      { shiftName: 'Morning Shift', startTime: '09:00', endTime: '18:00', requiredStaff: 5, location: 'Head Office' },
    ],
  },
  {
    id: 'T002', name: 'Sales Branch', department: 'Sales',
    shifts: [
      { shiftName: 'Morning Shift', startTime: '09:00', endTime: '18:00', requiredStaff: 3, location: 'Branch B' },
    ],
  },
];
